...
def load_data_from_graphdb():
    ...
    sparql_endpoint = "https://eb0f-114-10-144-166.ngrok-free.app/repositories/AksaraJawa"
    ...
    with tab2: # This is now the "Dataset" tab
        ...
        if not df.empty:
            ...
            <div class="custom-info-box">
                ...
                <p><strong>Endpoint:</strong> <a href= "https://eb0f-114-10-144-166.ngrok-free.app/repositories/AksaraJawa" target="_blank">https://eb0f-114-10-144-166.ngrok-free.app/repositories/AksaraJawa</a></p>
